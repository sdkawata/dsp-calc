...
describe("simpleSolver", () => {
    test("should solve mining", () => {
            expect(lpSolver({inputs: [{id: "A", rate: 1}], machines:{}, enabledRecipes: ["A"]}, [{id:"A", name: "A", time: 1, producers:["A-miner"]}], []))
    ...
    test("should solve crafting and mining", () => {
        expect(lpSolver({inputs: [{id: "A", rate: 1}], machines:{}, enabledRecipes: ["A", "B"]}, [
    ...
    test("should share ingredient factory", () => {
        expect(lpSolver({inputs: [{id: "A", rate: 1}], machines:{}, enabledRecipes: ["A","A1","A2","B"]}, [
    ...
    test("should consider factory.speed and time", () => {
        expect(lpSolver(
            {inputs: [{id: "A", rate: 1}], machines:{}, enabledRecipes: ["A"]},
